...
import com.skybooking.security.jwt.AuthEntryPointJwt;
import com.skybooking.security.jwt.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain apiSecurityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/vuelos/disponibles", "/api/vuelos/buscar").permitAll()
